...
public class SumExampleOuter extends JFrame
{
	JLabel l1,l2,l3;
	JTextField t1,t2;
	JButton b1;
...
class Handler implements ActionListener
{
	...
	{
		int a,b,sum;
		a = Integer.parseInt(s1.t1.getText());
		b = Integer.parseInt(s1.t2.getText());
		sum = a+b;
		s1.l3.setText("Sum: "+sum);
	}
}